        ...
        builder: (context, setState) {
          return AlertDialog(
            ...
            content: TimePickerSpinner(
              ...
              highlightedTextStyle: const TextStyle(fontSize: 24, color: Colors.white),
              spacing: 40,
              itemHeight: 60,
              isForce2Digits: true,
              onTimeChange: (time) {
            ...
            actions: [
              TextButton(
                child: const Text("Cancelar", textAlign: TextAlign.start, style: TextStyle(color: Colors.white)),
                            ...
                            actions: [
                              ...
                              ElevatedButton(
                                ...
                                onPressed: () {
                                  ...
                                  String data = procesarDatos(horaDormirStr, horaDespertarStr);
                                  ...
                                  Provider.of<Controllers>(
                                    ...
                                    listen: false,
                                      ...
                                      fechaFormateada, 0, data, horaDormirStr, horaDespertarStr, "0");
